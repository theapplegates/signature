  ...
  return (
    <div className="space-y-8">
      <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
        ...
        <p className="text-gray-500 mb-6">Algorithm: <span className="font-mono bg-gray-100 px-1.5 py-0.5 rounded">SLH-DSA-SHAKE-256f</span> (Winternitz-based, FIPS 205 fast variant)</p>
