...
export const CheckBadgeIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" {...iconProps} aria-hidden="true">
        <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zM12 15.25a.75.75 0 01.75-.75h.008a.75.75 0 01.75.75v.008a.75.75 0 01-.75.75h-.008a.75.75 0 01-.75-.75v-.008zM12 11a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" />
        <path d="M10.894 6.166a.5.5 0 00-.568.056l-3 3a.5.5 0 00.708.708L10.5 7.472l2.35 2.35a.5.5 0 00.707-.707l-3-3a.5.5 0 00-.163-.119z" />
    </svg>
);
...
export const CheckIcon: React.FC<{className?: string}> = ({className = "h-4 w-4 text-green-600"}) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
